...
$list=Yii::app()->functions->getFoodItemList($merchant_id);
?>
...
<?php echo CHtml::hiddenField('table','item')?>
<?php echo CHtml::hiddenField('whereid','item_id')?>
...
<?php if (is_array($list) && count($list)>=1):?>
  ...
  <?php foreach ($list as $val):?>
   <li class="uk-panel uk-panel-box" style="list-style:none;margin-bottom:5px;">
    <?php echo CHtml::hiddenField('sort_field[]',$val['item_id'])?>

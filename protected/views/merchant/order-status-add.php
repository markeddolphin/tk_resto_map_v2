...
<a href="<?php echo Yii::app()->request->baseUrl; ?>/merchant/orderStatus/Do/Add" class="uk-button"><i class="fa fa-plus"></i> <?php echo Yii::t("default","Add New")?></a>
...
<?php echo CHtml::hiddenField("redirect",Yii::app()->request->baseUrl."/merchant/orderStatus/Do/Add")?>
<?php endif;?>

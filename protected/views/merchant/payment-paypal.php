...
<div class="page merchant-payment-option">
  ...
  <?php echo CHtml::hiddenField('action','paymentPaypalVerification')?>  
  <?php echo CHtml::hiddenField('package_id',isset($_GET['package_id'])?$_GET['package_id']:'')?>
  <?php echo CHtml::hiddenField('token',$_GET['token'])?>    
  <?php echo CHtml::hiddenField('purchase',isset($_GET['purchase'])?$_GET['purchase']:'')?>  
  <?php echo CHtml::hiddenField('raw',isset($_GET['raw'])?$_GET['raw']:'')?>  
  ...
  <span class="uk-text-bold"><?php echo ucwords($res_paypal['L_NAME0'])?></span>
  </div>
